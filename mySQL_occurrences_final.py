...
INPUT_PATH = "ALA_dataset/ALA_Canterbury_bankstown/ALA_Canterbury_bankstown.csv"      # need to chage when the source is different
INPUT_TYPE = "csv"                         # "xlsx" or "csv"
SHEET_NAME = ""                       # only used if INPUT_TYPE == "xlsx"
OUTPUT_SQL = "ALA_Canterbury_bankstown.sql"     # output name

SOURCE_NAME = "ALA"
DATASET_NAME = "ALA_Canterbury_bankstown"   # change this for each import file
